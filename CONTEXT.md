...
- **Terminated (ยุติบัญชี):** นำออกจากการใช้งานปัจจุบันแต่เก็บประวัติไว้ และ Admin กู้คืนได้
...
คำขอจาก Teacher หรือ Student ให้ Admin พิจารณายุติบัญชี คำขอไม่เปลี่ยน Account Status จนกว่า Admin จะอนุมัติ
...
| "ปิดบัญชี" / "ลบบัญชี" | Suspended (พักบัญชี) / Terminated (ยุติบัญชี) / Anonymized (ทำข้อมูลนิรนาม) |
